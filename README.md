...
This EDA(Exploratory Data Analysis) project was conducted using Python Diwali Sales data. The Matplotlib, and Seaborn
for data manipulation, visualization, and analysis. The dataset contained information on sales, orders, amount, age,
sex, marital status, state, and occupation sector
